...
import lab.zlren.sell.common.form.CategoryForm;
...
public class SellerCategoryController {
    ...
    public ModelAndView index(@RequestParam(value = "categoryId", required = false) Integer categoryId,
        ...
        if (categoryId != null) {
            ProductCategory productCategory = this.ProductCategoryService.queryById(categoryId);
    ...
    public ModelAndView save(@Valid CategoryForm form,
        ...
        try {
            if (form.getCategoryId() != null) {
                productCategory = this.ProductCategoryService.queryById(form.getCategoryId());
            }
